...
title.config(bg='steel blue', fg='black')  
...
nbButton = Button(main, text="Naive Bayes Algorithm", command=runNaiveBayes)
nbButton.place(x=630,y=550)
nbButton.config(font=font1)

rfButton = Button(main, text="Random Forest Algorithm", command=runRandomForest)
...
xgButton = Button(main, text="XGBoost Algorithm", command=runXGBoost)
xgButton.place(x=330,y=600)
xgButton.config(font=font1) 

adaboostButton = Button(main, text="AdaBoost Algorithm", command=runAdaBoost)
adaboostButton.place(x=630,y=600)
adaboostButton.config(font=font1)

knnButton = Button(main, text="KNN Algorithm", command=runKNN)
